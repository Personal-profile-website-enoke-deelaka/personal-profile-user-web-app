...
@Component({
  selector: 'app-content-what-services-you-will-personal-profile-mobile',
  templateUrl: './content-what-services-you-will-personal-profile-mobile.component.html',
  styleUrls: ['./content-what-services-you-will-personal-profile-mobile.component.scss']
})
export class ContentWhatServicesYouWillPersonalProfileMobileComponent implements OnInit {
  col1Url: any;
  col2Url: any;
  col3Url: any;
  col4Url: any;
